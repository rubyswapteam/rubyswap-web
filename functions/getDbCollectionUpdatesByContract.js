...
export async function handler(event) {
  ...
  const API_ENDPOINT = `https://mqxsyzoydluqyuigceuy.supabase.co/rest/v1/CollectionUpdates?select=*&contractAddress=ilike.${event.queryStringParameters.contract}&order=timestamp.desc`;
