...
export async function handler(event) {
  ...
  const API_ENDPOINT = `https://eth-mainnet.alchemyapi.io/nft/v2/63TUZT19v5atqFMTgBaWKdjvuIvaYud1/getNFTs?withMetadata=true&owner=${event.queryStringParameters.user}${pageKey}`;
