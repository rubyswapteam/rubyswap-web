...
function handler(event) {
  var GEM_API_ENDPOINT, gemRequestOptions, SUPABASE_API_ENDPOINT, ethPrice, gasPrice, responseGem, data, collections, timestamp, i, collection, supabaseRequestOptions, responseSupabase;
