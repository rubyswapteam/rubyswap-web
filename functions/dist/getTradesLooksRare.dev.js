...
function handler(event) {
  var from, to, contract, cursor, API_ENDPOINT, response, data;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          cursor = event.queryStringParameters.cursor != undefined ? '&pagination[cursor]=' + event.queryStringParameters.cursor : '';
          API_ENDPOINT = 'https://api.looksrare.org/api/v1/events?type=SALE&pagination%5Bfirst%5D=150' + from + to + contract + cursor;
          _context.prev = 5;
          _context.next = 8;
