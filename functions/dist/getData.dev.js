  ...
  return regeneratorRuntime.async(function handler$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          from = event.queryStringParameters.from ? '&from_address=' + event.queryStringParameters.from : '';
          to = event.queryStringParameters.from ? '&to_address=' + event.queryStringParameters.to : '';
          contract = event.queryStringParameters.from ? '&contract=' + event.queryStringParameters.contract : '';
