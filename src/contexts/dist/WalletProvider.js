...
exports.WalletProvider = function (_a) {
    ...
    var fetchCollectionNames = react_1.useCallback(function (contractAddress) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (!collectionNames[contractAddress]) {
                axios_1["default"]
                    .get("https://eth-mainnet.g.alchemy.com/nft/v2/demo/getContractMetadata/?contractAddress=" + contractAddress)
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1["default"]
                            .get("https://eth-mainnet.alchemyapi.io/nft/v2/demo/getNFTs/?owner=" + user)
    ...
    var fetchUserNftsByCollection = react_1.useCallback(function (user, contract) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            axios_1["default"]
                .get("https://eth-mainnet.alchemyapi.io/nft/v2/demo/getNFTs/?owner=" + user + "&contractAddresses[]=" + contract)
                .then(function (res) {
    ...
    var fetchUserNftCollections = react_1.useCallback(function (user) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            axios_1["default"]
                .get("https://eth-mainnet.alchemyapi.io/nft/v2/demo/getNFTs/?owner=" + user + "&withMetadata=False")
                .then(function (res) {
                var userNfts = res.data.ownedNfts;
