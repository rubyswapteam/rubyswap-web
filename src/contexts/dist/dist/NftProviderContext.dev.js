...
exports.NftProvider = function (_a) {
  ...
  var _c = react_1.useState(),
      collectionUpdates = _c[0],
      setNftCollectionUpdates = _c[1];

  var _d = react_1.useState(),
      trendingNftCollections = _d[0],
      setTrendingNftCollections = _d[1];

  var _e = react_1.useState(),
      sweepNftCollections = _e[0],
      setSweepNftCollections = _e[1];

  var _f = react_1.useState(),
      nftCollection = _f[0],
      setNftCollection = _f[1];

  var fetchNftCollection = react_1.useCallback(function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var nftCollection;
      return __generator(this, function (_a) {
        nftCollection = {
          id: sampleCollection_1.SampleCollection[0]._id,
          contractAddress: sampleCollection_1.SampleCollection[0].addresses[0].address,
          contractAddressStandard: sampleCollection_1.SampleCollection[0].addresses[0].standard,
          description: sampleCollection_1.SampleCollection[0].description,
          isVerified: sampleCollection_1.SampleCollection[0].isVerified,
          image: sampleCollection_1.SampleCollection[0].imageUrl,
          bannerImage: sampleCollection_1.SampleCollection[0].banner_image_url,
          slug: sampleCollection_1.SampleCollection[0].slug,
          name: sampleCollection_1.SampleCollection[0].name,
          chainId: nftUtils_1.NftChainId.ETHEREUM,
          oneDayVolume: sampleCollection_1.SampleCollection[0].stats.one_day_volume,
          oneDaySales: sampleCollection_1.SampleCollection[0].stats.one_day_sales,
          oneDayAveragePrice: sampleCollection_1.SampleCollection[0].stats.one_day_average_price,
          sevenDayVolume: sampleCollection_1.SampleCollection[0].stats.seven_day_volume,
          sevenDaySales: sampleCollection_1.SampleCollection[0].stats.seven_day_sales,
          thirtyDaySales: sampleCollection_1.SampleCollection[0].stats.thirty_day_sales,
          thirtyDayVolume: sampleCollection_1.SampleCollection[0].stats.thirty_day_volume,
          floor: sampleCollection_1.SampleCollection[0].stats.floor_price,
          owners: sampleCollection_1.SampleCollection[0].stats.num_owners,
          count: sampleCollection_1.SampleCollection[0].stats.count,
          supply: sampleCollection_1.SampleCollection[0].stats.total_supply
        };
  ...
  var fetchNftCollectionUpdates = react_1.useCallback(function () {
    return __awaiter(void 0, void 0, void 0, function () {
  ...
  var fetchNfts = react_1.useCallback(function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var nfts, i, nft;
      return __generator(this, function (_a) {
        nfts = [];
        ...
        for (i = 0; i < sampleNfts_1.SampleNfts.length; i++) {
          nft = {
            ...
            price: sampleNfts_1.SampleNfts[i].currentBasePrice,
  ...
  var fetchAllTrendingNftCollections = react_1.useCallback(function () {
    return __awaiter(void 0, void 0, void 0, function () {
  ...
  var fetchAllSweepNftCollections = react_1.useCallback(function () {
    return __awaiter(void 0, void 0, void 0, function () {
  ...
  }, [nfts, setNfts, fetchNfts, trendingNftCollections, fetchAllTrendingNftCollections, sweepNftCollections, fetchAllSweepNftCollections, nftCollection, setNftCollection, fetchNftCollection, collectionUpdates, fetchNftCollectionUpdates, setNftCollectionUpdates]);
  return react_1["default"].createElement(NftProviderContext.Provider, {
    value: contextValue
  }, children);
};

exports.useNftProvider = function () {
  return react_1.useContext(NftProviderContext);
};