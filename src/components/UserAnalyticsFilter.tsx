...
const UserAnalyticsMarketplaceFilter: React.FC<Props> = ({
  ...
  return !!options ? (
    <Menu as="div" className="relative inline-block text-left self-center">
      ...
      >
        <Menu.Items className="origin-top-right absolute right-0 mt-2 whitespace-nowrap min-w-56 grow max-w-100 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none z-50">
          <div className="py-1 max-h-80 overflow-scroll">
            {options.map((option) => (
