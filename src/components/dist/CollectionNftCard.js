    ...
    return (react_1["default"].createElement("div", { className: "group relative" },
        react_1["default"].createElement("div", { className: 'drop-shadow-md rounded-xl text-sm bg-white dark:bg-white/5 hover:drop-shadow-xl' },
            react_1["default"].createElement("div", { className: 'w-full min-h-80 flex flex-col relative aspect-square overflow-hidden lg:h-50 lg:aspect-none cursor-pointer rounded-t-xl' },
                ...
                react_1["default"].createElement("span", { className: "border-2 border-white rounded-md absolute left-3 bottom-3 dark:bg-black dark:text-white bg-white text-black h-6 px-2 font-bold text-xs flex items-center justify-center" },
            ...
            react_1["default"].createElement("div", { className: "p-2" },
                ...
                react_1["default"].createElement("div", { className: "flex justify-between items-center text-xs" },
                    react_1["default"].createElement("div", { className: "pt-1" }, handleName() || '#'.concat(selectedNft.tokenId)),
                    react_1["default"].createElement("div", { className: "flex place-items-center" },
                        react_1["default"].createElement("div", { className: "pt-1" }, selectedNft.price),
                        (chainId == 1 || selectedNft.chainId == 1) && (react_1["default"].createElement(react_1["default"].Fragment, null,
