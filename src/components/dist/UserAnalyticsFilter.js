...
var UserAnalyticsMarketplaceFilter = function (_a) {
    var options = _a.options, defaultValue = _a.defaultValue, filter = _a.filter, collectionNames = _a.collectionNames;
    var applyTradeFilters = MarketplaceProviderContext_1.useMarketplaceProvider().applyTradeFilters;
    var _b = react_2.useState(defaultValue), activeName = _b[0], setActiveName = _b[1];
    function getContractFromCollection(name) {
        return Object.keys(collectionNames).find(function (contract) { return collectionNames[contract] == name; });
    }
    function getFilter(option) {
        var _a, _b;
        return filter == 'contract'
            ? (_a = {}, _a[filter] = getContractFromCollection(option.name), _a) : (_b = {}, _b[filter] = option.name, _b);
    }
                ...
                react_2["default"].createElement("div", { className: "py-1" },
                    react_2["default"].createElement(react_1.Menu.Item, null, function (_a) {
                        ...
                        return (react_2["default"].createElement("a", { href: "#", className: classNames(active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'group flex items-center px-4 py-2 text-sm'), onClick: function () {
                                ...
                                applyTradeFilters(undefined, (_a = {}, _a[filter] = '', _a));
                            } },
