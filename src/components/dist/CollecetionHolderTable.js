...
var CollectionHolderTable = function (_a) {
    ...
    return (react_1["default"].createElement("table", { className: "overflow-scroll inline-block rounded-md w-[50%]" },
        ...
        react_1["default"].createElement("tbody", { className: "h-64 overflow-scroll bg-white dark:bg-white/5 block w-full" }, holderCounts &&
...
exports["default"] = VerifiedBadgeIcon;
