...
function Dashboard(props) {
    ...
    var bannerStyle = (props === null || props === void 0 ? void 0 : props.banner) ? "linear-gradient(rgba(256, 256, 256, 0.4), rgba(256, 256, 256, 0.7)), url('" + (props === null || props === void 0 ? void 0 : props.banner) + "')"
        : '';
            ...
            React.createElement("div", { className: "md:pl-56 flex flex-col flex-1" },
                ...
                React.createElement("main", { className: "flex-1" },
                    React.createElement("div", { className: 'h-screen overflow-hidden flex-col flex' },
                        React.createElement("div", { className: "py-6 bg-gray-50 dark:bg-white/[.02] z-10 bg-cover", style: {
                                backgroundImage: "" + bannerStyle
                            } },
                            React.createElement("div", { className: "max-w-8xl mx-auto px-4 sm:px-6 md:px-8" },
                                React.createElement("h1", { className: "text-2xl font-semibold text-gray-900 dark:text-white" }, props.title)),
                            React.createElement("div", { className: "max-w-8xl mx-auto px-4 sm:px-6 md:px-8" },
