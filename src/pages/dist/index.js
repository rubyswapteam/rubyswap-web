...
function Index() {
    ...
    return (React.createElement("div", { className: "text-center flex flex-col items-center justify-center h-screen" },
        ...
        React.createElement(react_1.Transition, { show: count.current >= 0, enter: "transition-opacity duration-200", enterFrom: "opacity-0", enterTo: "opacity-100", leave: "transition-opacity duration-200", leaveFrom: "opacity-100", leaveTo: "opacity-0", className: "flex-col justify-center items-center" },
