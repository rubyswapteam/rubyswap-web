...
function Index() {
    ...
    function setBody() {
        ...
        if (tab === 'watchlist') {
            return React.createElement(WatchlistNftCollectionTable_1["default"], null);
        }
        if (tab === 'owned') {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Layout_1["default"], null,
            React.createElement(Dashboard_1["default"], { title: 'Browse', primaryTabs: React.createElement(Tab_1["default"], { tabs: primaryTabs }), secondaryTabs: React.createElement(Tab_1["default"], { tabs: nftUtils_1.rangeTabs(tab, range), condense: true }), body: setBody(), refresh: React.createElement(RefreshButton_1["default"], null) }))));
}
