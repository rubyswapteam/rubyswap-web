...
function Mints(props) {
    ...
    return (React.createElement("div", null,
        React.createElement(Layout_1["default"], null,
            React.createElement(Dashboard_1["default"], { setSearchModalState: props.setSearchModalState, title: 'Mints', primaryTabs: React.createElement(Tab_1["default"], { tabs: primaryTabs }), secondaryTabs: React.createElement(Tab_1["default"], { tabs: nftUtils_1.rangeTabs(tab, range, undefined, '30m'), condense: true }), body: setBody(), refresh: React.createElement(RefreshButton_1["default"], null) }))));
}
